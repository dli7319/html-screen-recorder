...
const recordBtnText = document.getElementById(
  'recordBtnText'
) as HTMLSpanElement;
...
const systemAudioToggle = document.getElementById(
  'systemAudioToggle'
) as HTMLInputElement;
const micAudioToggle = document.getElementById(
  'micAudioToggle'
) as HTMLInputElement;
const cropCheckbox = document.getElementById(
  'cropCheckbox'
) as HTMLInputElement;
const cropContainer = document.getElementById(
  'cropContainer'
) as HTMLDivElement;
const cropTargetElement = document.getElementById(
  'cropTargetElement'
) as HTMLDivElement;
...
async function handleShareScreen() {
  ...
  try {
    stream = await shareScreen(
      systemAudioToggle.checked,
      micAudioToggle.checked
    );
